...
import random   # for generating values for the rid variable
...
def lambda_handler(event, context):
    ...
    rid = random.sample(range(1000000000), 1) # <--- Replace this value with your code.
    # -----------------------------
    ...
    table = dynamodb.Table('CPC-predict-db-table')
